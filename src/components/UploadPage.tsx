...
const UploadPage = () => {
  ...
  const handleFileSelection = (file: File) => {
    ...
    if (file.size > maxSizeInBytes) {
      ...
      setError(
        `File size (${fileSizeInMB}MB) exceeds the 50MB limit. Please compress your video or use a smaller file.`
      );
      return;
    }
  ...
  const handleUploadAndProcessing = async () => {
    ...
    try {
      ...
      try {
        ...
        console.error("❌ TwelveLabs processing failed:", processingError);
        setError(
      ...
      >
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-lg p-8 text-center">
          ...
          <p className="text-slate-600 mb-6">
            We're carefully analyzing your conversation with empathy and
            respect.
          </p>
    ...
    >
      <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-lg p-8">
        ...
        <p className="text-slate-600 mb-8">
          Share your video file and we'll provide gentle, supportive analysis to
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="text-blue-700 text-sm space-y-1">
                ...
                <li>
                  • Video should show faces for facial expression analysis
                </li>
                <li>
                  • Conversations longer than 2 minutes provide better insights
                </li>

  ...
  const resourceCategories = [
    {
      ...
      resources: [
        ...
        },
        {
          ...
          description:
            "A comprehensive guide to identifying unhealthy patterns",
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-slate-600 max-w-2xl mx-auto">
          Gentle guidance and professional support to help you navigate
          difficult conversations and build healthier relationships.
        </p>
      </div>
          ...
          >
            ...
            <div className="space-y-4">
              {category.resources.map((resource, resourceIndex) => (
                <div
                  key={resourceIndex}
                  className={`border-2 rounded-2xl p-4 ${getColorClasses(
                    category.color
                  )}`}
                >
      ...
      <div className="mt-12 bg-blue-50 border-2 border-blue-200 rounded-3xl p-6">
        ...
        <p className="text-blue-700 text-sm leading-relaxed">
          This analysis tool is designed to provide insights and support, but it
          is not a substitute for professional mental health care. If you're
          experiencing ongoing manipulation, emotional abuse, or feel unsafe,
          please reach out to a qualified professional or crisis support
          service. Your safety and well-being are the top priority.
        </p>
      </div>

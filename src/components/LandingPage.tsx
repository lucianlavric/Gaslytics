  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach((particle, index) => {
        ...
        particle.x +=
          Math.sin(time + index * 0.1) * 0.3 + Math.sin(particle.wobble) * 0.5;
  ...
  const faqData = [
    {
      ...
      answer:
        "Yes, absolutely. We use enterprise-grade encryption and your conversations are automatically deleted after analysis. We never store or share your personal data with third parties.",
    },
    {
      question: "How accurate is the analysis?",
      answer:
        "Our analysis achieves 94% accuracy through advanced neural language processing and emotion recognition technology. We continuously improve our algorithms based on real-world data.",
    },
    {
      question: "What types of conversations can I analyze?",
      answer:
        "You can analyze any recorded conversation - from personal relationships to workplace interactions. Our system identifies patterns regardless of the context or participants.",
    },
    {
      question: "How long does the analysis take?",
      answer:
        "Most analyses are completed within 2-3 minutes. The processing time depends on the length of your conversation, but we'll show you real-time progress updates.",
    },
    {
      question: "Can I save my analysis results?",
      answer:
        "Yes, you can save your analysis for future reference. All saved data is encrypted and stored securely on your device or in your private account.",
    },
  ];
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 w-full z-20">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl text-slate-600 mb-12 max-w-4xl mx-auto leading-relaxed">
              Gaslytics uses advanced AI to analyze conversations and reveal
              hidden patterns, manipulation techniques, and communication
              dynamics. Get clarity on difficult interactions with unbiased,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-green-50/50 via-yellow-50/30 to-red-50/50 rounded-3xl p-8 backdrop-blur-sm border border-white/20">
            <div className="grid lg:grid-cols-2 gap-8 items-stretch mb-8">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 flex flex-col justify-between min-h-[600px]">
                <div>
                  ...
                  <p className="text-xl text-slate-600 leading-relaxed">
                    Watch how our advanced AI analysis reveals hidden patterns,
                    manipulation techniques, and communication dynamics that
                ...
                <div className="flex justify-center mt-8">
                  <div className="relative w-56 h-56">
                    {emoticons.map((emoticon, index) => (
                      ...
                      >
                        <div
                          className={`w-40 h-40 bg-gradient-to-br ${emoticon.color} rounded-full flex items-center justify-center shadow-2xl mb-4 transform hover:scale-110 transition-transform duration-300`}
                        >
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border border-white/20 min-h-[600px]">
                <div className="w-full h-full">
                  <iframe
                    src="https://www.youtube.com/embed/k2jafAM2C9c"
            ...
            <div className="flex justify-center">
              <div className="flex items-center text-base text-slate-600 bg-white/60 backdrop-blur-sm rounded-full px-6 py-3 shadow-sm border border-white/20">
                ...
                <span>
                  Real-time analysis • 94% accuracy • Instant insights
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Professional-grade conversation analysis designed for clarity and
              understanding
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-slate-600">
                Your conversations are encrypted and automatically deleted after
                analysis. We never store or share your personal data.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-slate-600">
                Our AI provides objective analysis without human bias, helping
                you see patterns you might have missed.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-slate-600">
                Get specific strategies and resources to improve future
                conversations and build healthier relationships.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-slate-600">
                Get comprehensive analysis results in minutes, not hours. Our
                advanced processing delivers insights quickly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <div
                className="absolute text-3xl text-green-400/60"
                style={{
              ...
              <div
                className="absolute text-2xl text-yellow-400/60"
                style={{
              ...
              <div
                className="absolute text-4xl text-red-400/60"
                style={{
              ...
              <div
                className="absolute text-2xl text-green-400/60"
                style={{
              ...
              <div
                className="absolute text-3xl text-yellow-400/60"
                style={{
              ...
              <div
                className="absolute text-2xl text-red-400/60"
                style={{
              ...
              <div
                className="absolute text-2xl text-blue-400/60"
                style={{
              ...
              <div
                className="absolute text-3xl text-purple-400/60"
                style={{
              ...
              <div
                className="absolute text-2xl text-orange-400/60"
                style={{
              ...
              <div
                className="absolute text-3xl text-pink-400/60"
                style={{
          ...
          <div className="space-y-4 relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <div
                className="absolute text-xl text-green-400/40"
                style={{
              ...
              <div
                className="absolute text-lg text-yellow-400/40"
                style={{
              ...
              <div
                className="absolute text-xl text-red-400/40"
                style={{
              ...
              <div
                className="absolute text-lg text-blue-400/40"
                style={{
              ...
              <div
                className="absolute text-xl text-purple-400/40"
                style={{
              ...
              <div
                className="absolute text-lg text-orange-400/40"
                style={{
              ...
              <div
                className="absolute text-xl text-pink-400/40"
                style={{
              ...
              <div
                className="absolute text-lg text-green-400/40"
                style={{
              ...
              <div
                className="absolute text-xl text-yellow-400/40"
                style={{
              ...
              <div
                className="absolute text-lg text-red-400/40"
                style={{
            ...
            {faqData.map((faq, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-slate-200/50 relative z-10"
              >
                <button
      ...
      <section className="py-20 bg-gradient-to-r from-green-600/20 via-yellow-500/30 to-red-500/40 backdrop-blur-sm relative z-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl lg:text-2xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Join thousands of users who have gained clarity and insight through
            professional conversation analysis.
          </p>
          <Link
            to="/consent"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Advanced conversation analysis powered by AI to help you
